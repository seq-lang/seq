...
void ASTVisitor::visit(const InstantiateExpr *e) { defaultVisit(e); }
void ASTVisitor::visit(const StaticExpr *e) { defaultVisit(e); }
void ASTVisitor::visit(const StmtExpr *e) { defaultVisit(e); }
