...
struct type_2 : pegtl::sor<seq_type, int_type, float_type, bool_type, record_type, func_type> {};
...
struct type : pegtl::sor<array_type, record_type, func_type, seq_type, int_type, float_type, bool_type> {};
