...
atom: /* Basic structures: identifiers, nums/strings, tuples/list/dicts */
  ...
  | TRUE { Bool true}
  | FALSE { Bool false }
  /* TODO needs support for single quote strings and prefix strings */
  | STRING { String $1 } 
  | tuple | list | dict { $1 }
tuple: /* Tuples: (1, 2, 3) */
  /* TODO needs generator support */
  | LP RP { Tuple [] }
  | LP test COMMA RP { Tuple [$2] }
  | LP test_list RP { Tuple $2 }
list: /* Lists: [1, 2, 3] */
  /* TODO needs trailing comma support and generators */
  | LS RS { List [] }
...
statement: /* Statements */
  ...
  | FOR test IN test_list COLON suite { For ($2, $4, $6) }
...
%inline aug_eq: 
  /* TODO: bit shift ops and pipe-eq */
...
decorator:
  ...
  | AT dotted_name LP separated_nonempty_list(COMMA, arg) RP NL { Decorator ($2, $4) }
dotted_name:
  | ID { Id $1 }
...
param:
  /* TODO tuple params--- really needed? */
